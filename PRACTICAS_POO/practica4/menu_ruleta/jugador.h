...
class Jugador:public Persona{
    ...
    inline int getDinero(){return dinero_;};                    //Función que retorna el valor de dinero_
    inline std::list<Apuesta> getApuestas(){return apuestas_;}; //Función que retorna el valor de apuestas_

    inline void setCodigo(std::string codigo){codigo_=codigo;}; //Función que realiza operaciones sobre codigo_
    inline void setDinero(int dinero){dinero_=dinero;};         //Función que realiza operaciones sobre dinero_
