...
class Ruleta{
    ...
    int nLanzamientos_;                                                 //Declaración de una variable de tipo entero que guardará el número de lanzamientos
    int nJugadores_;                                                    //Declaración de una variable de tipo entero que guardará el número de jugadores
    int ganadoBanca_;                                                  //Declaración de una variable de tipo entero que guardará la ganancia de la banca
    ...
    void getEstadoRuleta( int &nJugadores, int &dineroMesa, int &nLanzamientos, int &ganadoBanca);      //Función que muestra el estado de la ruleta en un cierto momento
