...
void Dados::Insertador(){
    ...
    std::cout << "El valor del dado 1 es : " << d1_;    //Mostramos por pantalla el valor del dado 1
    std::cout << "EL valor del dado 2 es : " << d2_;    //Mostramos por pantalla el valor del dado 2
}

void Dados::Extractor(){

    int dado=1;                                                                             //Declaración de una variable de tipo entero para asignar valores a los dado
    std::cout << "Introduzca el valor del dado 1: ";
    std::cin >> dado;                                                                       //Asignamos un valor a dado
    while(dado<1  || dado>6){                                                               //Mientras el valor asignado a dado no esté entre estos valores, se creará un bucle 
        std::cout << "Error, el número introducido no es valido, introduzca otro" << "\n";
        std::cin >> dado;                                                                   //Asignamos un valor a dado
    }
