...
{
    bool aflag = false;  //Variable de tipo bool puesta a false para reconocer la opción a
    bool bflag = false;  //Variable de tipo bool puesta a false para reconocer la opción b
    char *cvalue = NULL; //Variable de tipo char puesta a NULL paraa guardar el valor de c
    int index;           //
    int c;
