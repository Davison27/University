...
protected:
  ...
  typename AVLTNode<T>::Ref raiz_;   //Insertamos una variable llamada raiz
  typename AVLTNode<T>::Ref actual_; //Insertamos una variable llamada actual
  typename AVLTNode<T>::Ref previo_; //Insertamos una variable llamada previo
};
